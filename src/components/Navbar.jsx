...
const Navbar = () => {
    ...
    return (
        <header className='header flex justify-between items-center p-4 relative bg-white bg-opacity-50 backdrop-blur-md'>
            ...
            absolute md:static bg-white bg-opacity-5 md:bg-transparent w-[30%] md:w-auto top-14 md:top-auto 
            rounded-lg left-3/4 p-4 md:p-0 shadow-md md:shadow-none backdrop-blur-md font-poppins`}>
                ...
                <a href='/assets/Resume.pdf' target='_blank' rel='noreferrer' className="block px-2 py-1 md:py-0 text-black">
                    Resume
                </a>
            </nav>
        </header>
